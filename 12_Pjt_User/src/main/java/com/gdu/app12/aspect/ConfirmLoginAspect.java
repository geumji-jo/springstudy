...
public class ConfirmLoginAspect {
	...
	// 포인트컷 : ComfirmLoginAspect를 동작시킬 메소드
	// 모든 매개변수 = ..
	// requiredLogin_로 시작하는 메소드 = ..requiredLogin_*
	// class 형태의 모튼 컨틀롤러 = *Controller
	// 패키지 경로 = com.gdu.app12.controller.
	
	@Pointcut("excution(* com.gdu.app12.controller.*Controller.requiredLogin_*(..))")

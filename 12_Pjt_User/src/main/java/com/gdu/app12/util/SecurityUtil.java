...
public class SecurityUtil {
	...
	public String getRandomString(int count, boolean letters, boolean numbers) {
		return RandomStringUtils.random(count, letters, letters);
	}
	...
	/*
		...
		5. 32바이트 -> 16진수로 변환하면 64글자가 생성된다. (db칼럼의 크기를 varchar2(64byte)로 설정한다.)
	...
	public String getSha256(String str) {
		...
		byte[] b = messageDigest.digest(); 	//암호화된 32바이트 크기의 byte 배열 b가생성된다.

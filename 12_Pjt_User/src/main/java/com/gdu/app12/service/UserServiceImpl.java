  ...
  @Override
	public void login(HttpServletRequest request, HttpServletResponse response) {
		// 요청 파라미터
	  	...
	  	String id = request.getParameter("id"); 	// 로그인 화면의 이전 주소(로그인 후 되돌아갈 주소)
	  	String pw = request.getParameter("pw"); 	// 로그인 화면의 이전 주소(로그인 후 되돌아갈 주소)
	...
	public void logout(HttpServletRequest request, HttpServletResponse response) {
  	...
  	// insert,delete를 동시에 해서 leave메소드는 트랜젝션 처리 대상이 된다.

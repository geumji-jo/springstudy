...
<!-- Footer -->
    <div class="container-fluid container-footer" style="margin-top:40px; margin-bottom:0px;">
        <div class="row">
            <div class="col-sm-9 policys">
				<ul class="footer-ul">
            ...
            <div class="col-sm-3">
                <div class="share">
                    <a href="https://www.facebook.com/CJCGV" target="_blank" class="facebook" title="새창"><img src="/jf/photos/footer_facebook.PNG"></a>
                    <a href="https://twitter.com/cj_cgv" target="_blank" class="twitter" title="새창"><img src="/jf/photos/footer_twitter.PNG"></a>
                    <a href="https://www.instagram.com/cgv_korea/" target="_blank" class="instagram" title="새창"><img src="/jf/photos/footer_instargram.PNG"></a>
                </div>
            </div>
        </div>	   
        <hr/>
        <div class="row address">
           <div class="col-sm-2 footer-logo">
               <img src="/jf/photos/footer_logo.PNG" width="40%">
           </div>
            <div class="col-sm-7 footer-info">
				...
				<p class="vl">
					<span>개인정보보호 책임자 : 정종민</span><span>대표이메일 : cjcgvmaster@cj.net</span><span>CGV고객센터 : 1544-1122</span>
				</p>
            </div>
            <div class="col-sm-3 familysite">
                <div>
                    ...
                    <select id="familysite">
                        <option value="">계열사 바로가기</option>
                          <optgroup label="CJ그룹">
                            ...
                            <option value="http://www.oliveyoung.co.kr/store/main/main.do">CJ올리브네트웍스 (올리브영)</option>
                            </optgroup><optgroup label="인프라">
                            <option value="http://www.cjenc.co.kr/">CJ대한통운 (건설)</option>
                            <option value="http://www.cjolivenetworks.co.kr/itbusiness/">CJ올리브네트웍스 (IT사업)</option>
                            </optgroup>                 
                    </select>

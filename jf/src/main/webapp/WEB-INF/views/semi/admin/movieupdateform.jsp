...
<body style="background-color: #fdfcf0;">
    ...
    <div class="container well">
        <form method="post" action="updateMovie.jf" enctype="multipart/form-data">
            <div class="row">
                <div class="col-sm-6 text-center" style="margin-top: 5px;">
                    <img src="/jf/photos/movieposters/${movie.poster }" id="poster-box" class="img-thumbnail" width="200" height="280" />
                    <hr />
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>영화이름(한국어)</label> <input type="text" class="form-control" name="korTitle" value="${movie.korTitle }">
                    </div>
                    <div class="form-group">
                        <label>영화이름(영어)</label> <input type="text" class="form-control" name="engTitle" value="${movie.engTitle }">
                    </div>
                    <div class="form-group">
                        <label>영화감독</label> <input type="text" class="form-control" name="director" value="${movie.director }">
                    </div>
                    <div class="form-group">
                        <label>영화배우</label> <input type="text" class="form-control" name="actors" value="${movie.actors }">
                    </div>
                    <div class="form-group">
                        <label>제작국가</label> <select class="form-control" name="country">
                            <option value="선택">선택</option>
                            <option value="한국" ${movie.country=='한국' ? 'selected' : '' }>
                                한국</option>
                            <option value="미국" ${movie.country=='미국' ? 'selected' : '' }>
                                미국</option>
                            <option value="일본" ${movie.country=='일본' ? 'selected' : '' }>
                                일본</option>
                            <option value="중국" ${movie.country=='중국' ? 'selected' : '' }>
                                중국</option>
                            <option value="홍콩" ${movie.country=='홍콩' ? 'selected' : '' }>
                                홍콩</option>
                            <option value="프랑스" ${movie.country=='프랑스' ? 'selected' : '' }>
                                프랑스</option>
                            <option value="영국" ${movie.country=='영국' ? 'selected' : '' }>
                                영국</option>
                            <option value="독일" ${movie.country=='독일' ? 'selected' : '' }>
                                독일</option>
                            <option value="인도" ${movie.country=='인도' ? 'selected' : '' }>
                                인도</option>
                            <option value="기타" ${movie.country=='기타' ? 'selected' : '' }>
                                기타</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="releaseDate" value=" <fmt:formatDate value="${movie.releaseDate}" pattern="yyyy-MM-dd" /> "  /><br />
                    </div>
                    <div class="form-group">
                        <label>영화상영시간</label> 
                        <input type="text" name="runningTime" value="${movie.runningTime}" /><br />
                    </div>
                    <div class="form-group">
                        <label>영화장르</label>
                        <div class="radio">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            ...
                            <label class="radio-inline"> <input type="radio" name="ageLimit" value="0" ${movie.ageLimit=='0' ? 'checked' : '' }> 전체관람가
                            </label> <label class="radio-inline"> <input type="radio" name="ageLimit" value="12" ${movie.ageLimit=='12' ? 'checked' : '' }> 12세관람가
                            </label> <label class="radio-inline"> <input type="radio" name="ageLimit" value="15" ${movie.ageLimit=='15' ? 'checked' : '' }> 15세관람가
                            </label> <label class="radio-inline"> <input type="radio" name="ageLimit" value="18" ${movie.ageLimit=='18' ? 'checked' : '' }> 청소년관람불가
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <label>영화줄거리</label><textarea class="form-control" rows="10" name="info">${movie.info}</textarea>
                    </div>
            ...
            <input type="hidden" name="mno" value="${movie.no }">
